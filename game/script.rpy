...
label start:
    ...
    xl "咦，好脏。"
    worker "啊？！什么人！"#1_1_1
    play voice worker1_1_1
    xl "这是哪里？"
    worker "外地人？奇怪了……"#1_2_1
    play voice worker1_2_1
    worker "最近怪事本来就多，你该不会是什么……"#1_2_2
    play voice worker1_2_2
    xl "是什么？"
    worker "你该不会是我的工友吧？最近那股力量出现的越来越频繁，很多人看见了朋友年轻时的样子。"#1_3_1
    play voice worker1_3_1
    xl "啊？我不是，我叫小林，来自乌泽镇。"
    worker "……？你是不是早晨起太早，还在做梦？这是是艾瑟克小镇，哪有什么乌泽镇，我可从来没有听说过那个地方。"#1_4_1
    play voice worker1_4_1
    worker "是最近那股力量增强了吗？平常这样的现象只持续几秒钟。"#1_4_2
    play voice worker1_4_2
    xl "我真不是你的工友，我叫小林。"
    worker "或许你真不是，小林是吧，跟我来，我带你去见上头的人。"#1_5_1
    play voice worker1_5_1
    xl "好……好的。"
